// GENERATED FROM examples/memory-plugin-shared/lib/profile-inject.mjs (volcengine/OpenViking). DO NOT EDIT.
// Vendored for the SessionStart profile-inject hook; resync by copying the upstream file and re-prepending this header.
/**
